...
## 5️⃣ RichTextEditor (React-Quill)
...
- TypeScript용 CSS 선언 **globals.d.ts** 추가:
  ...
  ```
- 이미지 업로드 핸들러 포함
- 설치: `npm install react-quill@2.0.0`, `npm install --save-dev @types/react-quill` (타입 없으면 직접 정의)
...
- **환경 변수 등록**: `DATABASE_URL`, `NAVER_MAP_KEY` 등 (위 2️⃣ 참고)
